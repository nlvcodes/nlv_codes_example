  ...
  plugins: [
    formBuilderPlugin({
      ...
      formOverrides: {
        ...
        // TODO for caching in a Next.js video later on
        // hooks: {
        //   afterChange: [
        //     ({ doc }) => {
          ...
          afterChange: [
            async ({ doc, req }) => {
              ...
              const sendSubmissionToHubSpot = async (): Promise<void> => {
                ...
                try {
                  await fetch(
                    `https://api.hsforms.com/submissions/v3/integration/submit/${portalID}/${form.hubspotID}`,
                    {
                  ...
                  req.payload.logger.error({
                    e,
                    msg: 'Form submission not sent to HubSpot.',
                  })
                }
              }
